...
⚠️ Change the password immediately after login.
  Sometimes password will be randomly generated by the FileBrowser conatiaer (.yaml) Itself. The will be provided only first time you run the compose file and then you will have to store it securely until you     change it from the Dashboard.  
---
